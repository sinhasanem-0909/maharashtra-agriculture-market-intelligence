...
function renderAgricultureUniverse() {
  ...
  target.innerHTML = `
    ...
    <div class="table-wrap agriculture-table"><table><thead><tr><th>Commodity</th><th>Category</th><th>Area</th><th>Production</th><th>Yield</th><th>Production change</th><th>Demand</th><th>Supply</th><th>Mandi</th></tr></thead><tbody id="agricultureRows"></tbody></table></div>`;
